      ...
      <>
        <div className="scorecard-container">
          ...
          <div className="score-card-details">
            ...
            <button className="playAgainButton" onClick={this.playAgain}>
                <img className ="playAgainIcon" src="https://assets.ccbp.in/frontend/react-js/match-game-play-again-img.png " alt="reset" />
                PLAY AGAIN
            </button>
          </div>
        </div>
